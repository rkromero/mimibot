...
ALTER TYPE "public"."estado_pedido" ADD VALUE IF NOT EXISTS 'pendiente_aprobacion' BEFORE 'confirmado';--> statement-breakpoint
ALTER TYPE "public"."user_role" ADD VALUE IF NOT EXISTS 'vendedor';--> statement-breakpoint
