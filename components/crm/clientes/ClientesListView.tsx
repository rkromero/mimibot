...
export default function ClientesListView() {
  ...
  return (
    <div className="w-full h-full overflow-y-auto">
      ...
      <button
        onClick={() => setShowCreate(true)}
        className="fixed right-4 z-30 flex items-center gap-2 h-14 rounded-full bg-primary text-primary-foreground shadow-lg px-5 md:hidden active:scale-95 transition-transform"
